    ...
    <section id="projects">
      ...
      <div className="container portfolio_container item">
        <article className="portfolio_item item">
          ...
          <h3>KiwiMart</h3>
          <small>
            Online shopping webapp with an admin dashboard allowing for CRUD
            operations. This project was built in a team of 3, where I acted as
            a project manager and was responsible for integrating the backend
        ...
        <article className="portfolio_item item">
          ...
          <small>
            This is a live messaging chat app built through React. Firebase is
            used for storage of messages, images, and users.
          </small>
          <br />
        ...
        <article className="portfolio_item item">
          ...
          <small>
            This is a revisited version of my first project (weather app). It
            includes various improvements to the UI, functionality, and
            features.
          </small>
          <br />
          <p>
        ...
        <article className="portfolio_item item">
          ...
          <small>
            A react webapp which calls to an exercise API, displaying suggested
            exercises and calls from a youtube search API to recommend videos.
            This project was built in a team of 2
          </small>
          <br />
          <p>
            Skills : React, JavaScript, CSS, HTML, ExerciseDB/YoutubeSearch API
          </p>
          <div className="portfolio_item-cta">
            <a
